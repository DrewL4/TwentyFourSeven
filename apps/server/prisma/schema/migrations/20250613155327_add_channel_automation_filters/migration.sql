...
INSERT INTO "new_channel" ("_id", "createdAt", "episodeMemoryEnabled", "groupTitle", "guideFlexPlaceholder", "guideMinimumDurationSeconds", "icon", "iconDuration", "iconPosition", "iconWidth", "isOnDemand", "name", "number", "onDemandModulo", "startTime", "stealth", "updatedAt") SELECT "_id", "createdAt", "episodeMemoryEnabled", "groupTitle", "guideFlexPlaceholder", "guideMinimumDurationSeconds", "icon", "iconDuration", "iconPosition", "iconWidth", "isOnDemand", "name", "number", "onDemandModulo", "startTime", "stealth", "updatedAt" FROM "channel";
DROP TABLE "channel";
